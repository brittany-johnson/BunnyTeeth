	...
	*/
    ...
    void Update()
    {
        if (Time.realtimeSinceStartup > 3f)
        {
            ...
            rotationX += Input.GetAxis("Mouse X") * cameraSensitivity * speedFactor * Time.deltaTime;
            rotationY += Input.GetAxis("Mouse Y") * cameraSensitivity * speedFactor * Time.deltaTime;
            ...
            if (Input.GetKey(KeyCode.Q)) { transform.position += transform.up * climbSpeed * speedFactor * Time.deltaTime; }
            if (Input.GetKey(KeyCode.E)) { transform.position -= transform.up * climbSpeed * speedFactor * Time.deltaTime; }
